package edu.yonatan.mywhatsupclonechat.login_register_activities;
...
import edu.yonatan.mywhatsupclonechat.MainActivity;
import edu.yonatan.mywhatsupclonechat.R;


public class UserPhoneRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(UserPhoneRegisterActivity.this, "Please Enter a Valid Number and Try Again.", Toast.LENGTH_SHORT).show();
